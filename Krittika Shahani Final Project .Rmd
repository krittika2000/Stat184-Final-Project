...
The pimary data scource lists the statistics and numbers based on content that Netflix produces
My secondary data source analyses the data of Netflix content based on the ratings given by the people . 

I have tried looking and analysis data and questions from both points of view !
